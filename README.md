...
| `CF_USER_ACCESS_KEY_ID_19S` | API | Keeping data across restarts | R2 API token access key |
| `CF_USER_R2_SECRET_ACCESS_KEY_19S` | API | Keeping data across restarts | R2 API token secret |
| `GROQ_API_KEY`, `GEMINI_API_KEY`, `OPENROUTER_API_KEY_19S`, `CEREBRAS_API_KEY_19S`, `MISTRAL_API_KEY`, `NVIDIA_API_KEY_19S`, `HF_TOKEN` | API | Refresh (AI extraction) | Free-tier keys; any subset works, more keys = more free quota |
