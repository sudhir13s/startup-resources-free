...
// Categories that belong on the Grants & Credits tab. Pulled from the
// existing seed-shape category enum (still using the legacy plural
// forms — see provider-schema.md for the canonical singulars).
...
export default async function GrantsPage({
  ...
  let items = all.filter((p) => GRANT_CATEGORIES.has(p.category));
